...
// The first 637 lines are stable and contain all the imports, logic, and CSS.
const header = lines.slice(0, 638).join('\n');
...
fs.writeFileSync(file, header + newReturn, 'utf8');
console.log('Fixed Signup.js');
