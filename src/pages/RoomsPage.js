...
const css = `
  ...
  @media (min-width: 640px) {
    .rooms-grid { display: grid; grid-template-columns: repeat(2, 1fr); }
  }
  ...
  @media (min-width: 640px) {
    .sheet {
      ...
      animation: zoomIn 0.25s cubic-bezier(0.32,0.72,0,1);
      max-height: 88vh;
    }
    @keyframes zoomIn {
...
export default function Rooms() {
  ...
  const getOccupiedBeds = (roomNumber) =>
    tenants.filter(t => t.roomNumber === roomNumber)
      ...
      <div className="rooms-root">
        ...
        <div className="rooms-topbar">
          <div className="rooms-topbar-row">
            <div>
              ...
              <p className="rooms-page-sub">{rooms.length} rooms · {vacantBeds} beds available</p>
            </div>
        ...
        <div className="rooms-stats">
          {[
            ...
            { label: 'Beds',     value: totalBeds,    color: '#0891b2' },
            { label: 'Occupied', value: occupiedBeds, color: '#dc2626' },
            { label: 'Vacant',   value: vacantBeds,   color: '#059669' },
                    ...
                    <div className="bed-section">
                      ...
                      <div className="bed-legend">
                        <div className="bed-legend-item">
                          <div className="bed-legend-dot" style={{ background: '#059669' }} />
                          Vacant
                        </div>
                        <div className="bed-legend-item">
                          <div className="bed-legend-dot" style={{ background: '#dc2626' }} />
                          Occupied
                        </div>
                      </div>
                    </div>
